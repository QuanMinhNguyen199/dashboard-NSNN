import { LOCATIONS, SOURCES, SOURCE_BY_CODE, YEARS, type SourceCode } from "../dashboard/catalog";
import { periodCount, periodTokenLabel } from "../dashboard/selectors";
import { useAdvancedComparison } from "../dashboard/useResource";
import type { AdvancedComparisonData, AdvancedComparisonMode } from "../dashboard/types";
import { useDashboardState } from "../state/DashboardState";
import { GridRows } from "../ui/Grid";
import { TrendChart, WaterfallChart } from "../ui/charts";
import { Card, CoverageNote, ResourceView, Segmented, money, pct } from "../ui/primitives";
